...
using System.IO;
using KimHaiQuang.SharpDCIIDE.Services;
using KimHaiQuang.SharpDCIIDE.Infrastructure.Services;
using Microsoft.VisualStudio.ComponentModelHost;
using KimHaiQuang.SharpDCIIDE.Presentation.View;
...
namespace KimHaiQuang.SharpDCIIDE
{
    ...
    [Guid(GuidList.guidSharpDCIIDEPkgString)]
    [ProvideAutoLoad(UIContextGuids80.SolutionExists)]
    public sealed class SharpDCIIDEPackage : Package
    {
        ...
        private void RegisterCommand()
        {
            ...
            if (null != mcs)
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidSharpDCIIDECmdSet, (int)PkgCmdIDList.cmdidSharpDCIIDE);
